...
int main()
{
	...
	const unsigned int nx = 24;						    // number of cells along x
	...
	const double nu = 0.01;								// kinematic viscosity [m2/s]
	const double tau = 10;								// total time of simulation [s]


	// Parameters for SOR
	const unsigned int max_iterations = 10000;  // maximum number of iterations
	const double beta = 1.3;					// SOR coefficient
	...
	Eigen::MatrixXd po(nx + 2, ny + 2); po.setZero();			// pressure at previous time [Pa]
